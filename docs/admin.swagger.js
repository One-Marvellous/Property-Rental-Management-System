 ...
 *     description: Retrieve all users with pagination and optional date filtering. Admin only.
 *     tags:
 *       - Admin
 *     security:
 *       - BearerAuth: []
 ...
 *     description: Update the description of an existing category. Admin only.
 *     tags:
 *       - Admin
 *     security:
 *       - BearerAuth: []
 ...
 *     description: Retrieve all manager applications with pagination, status filtering, and date filtering. Admin only.
 *     tags:
 *       - Admin
 *     security:
 *       - BearerAuth: []
 ...
 *     description: Retrieve details of a specific manager application including user information. Admin only.
 *     tags:
 *       - Admin
 *     security:
 *       - BearerAuth: []
 ...
 *     description: Approve a pending manager application and assign manager role to user. Admin only.
 *     tags:
 *       - Admin
 *     security:
 *       - BearerAuth: []
 ...
 *     description: Retrieve pending property submissions awaiting approval with pagination and date filtering. Admin only.
 *     tags:
 *       - Admin
 *     security:
 *       - BearerAuth: []
 ...
 *     description: Reject a pending property submission with a reason. Admin only.
 *     tags:
 *       - Admin
 *     security:
 *       - BearerAuth: []
 ...
 *               rejectionReason:
 *                 type: string
 *                 example: Property does not meet quality standards
 *     responses:
 *       200:
 ...
 *     description: Suspend an approved property from public listing. Admin only.
 *     tags:
 *       - Admin
 *     security:
 *       - BearerAuth: []
